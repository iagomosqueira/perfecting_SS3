...
#C Starter.ss version: C:\000\1001_ICCAT_BSH_2023\SS3\2023_Model_1\000_Excel_03_Forecast\2023_09_Ref_Case\v1(7_8_2023)																
data.ss
control.ss
...
2031 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2031
...
4 # F_reporting_units: 0=skip; 1=exploitation(Bio); 2=exploitation(Num); 3=sum(Apical_F's); 4=true F for range of ages; 5=unweighted avg. F for range of ages
 0 28 #_min and max age over which average F will be calculated, with F=Z-M
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1690265479
